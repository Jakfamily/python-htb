...
import click  # Importe le module click pour créer des interfaces en ligne de commande
from threading import Thread  # Importe Thread du module threading pour le multithreading
